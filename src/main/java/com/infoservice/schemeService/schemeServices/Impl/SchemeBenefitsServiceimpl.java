...
public class SchemeBenefitsServiceimpl  implements SchemeBenefitsService {
    ...
    @Override
    public List<SchemeBenefits> readSchemeBenefitsBySchemeName(String schemeName) {
        List<SchemeBenefits> ss = schemeBenefitsRepository.findBySchemeName(schemeName).orElse(null);
    ...
    public SchemeBenefits updateSchemeBenefitsById(Long id, SchemeBenefits updateBenefits) {
        ...
        existingBenefits.setSchemeName(updateBenefits.getSchemeName());
        existingBenefits.setStepNo(updateBenefits.getStepNo());

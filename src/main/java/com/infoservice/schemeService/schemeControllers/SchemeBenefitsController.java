...
public class SchemeBenefitsController {
    ...
    public String demoController(){
        return "Hello Controller" + schemeBenefitsService.demoService();
    }
    ...
    @GetMapping("/get-scheme-benefits/{schemeName}")
    public List<SchemeBenefits> getSchemeBenefitsBySchemeName(@PathVariable String schemeName){
         List<SchemeBenefits> s = schemeBenefitsService.readSchemeBenefitsBySchemeName(schemeName);
        return s;
    }
